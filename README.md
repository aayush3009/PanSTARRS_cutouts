...
To successfully run this script, users must have installed numpt, astropy, and Montage, which can be found [here](http://montage.ipac.caltech.edu/docs/download.html)
